...
export interface IClientOverlayInterface {
    outerContainer: HTMLElement;
    wrapper: HTMLElement;
    sidePanel: HTMLElement;
    activeButton: string;
    interfaceExitButton: HTMLElement;
    setup();
    loadingScreen();
    show(content: any, sidebar?: boolean);
    hide();
    createSidePanelTabs();
    showContent(eventButton?: Event, selectedButton?: HTMLElement);
    adjustWrapperHeight();
    addEventSidePanelTab();
    interfacePageTitle: string;
