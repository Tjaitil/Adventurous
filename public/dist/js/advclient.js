...
export class Game {
    ...
    static async loadWorld(parameters = {}) {
        window.cancelAnimationFrame(Game.properties.requestId);
    ...
    static setup() {
        ...
        viewport.setup([
            ...
            document.getElementById("text_canvas"),
        ]);
    ...
    static update(timestamp, first = false) {
        ...
        if (GamePieces.player.travel === true)
            return false;
        ...
        if ((GamePieces.player.speedX != 0 || GamePieces.player.speedY != 0) &&
