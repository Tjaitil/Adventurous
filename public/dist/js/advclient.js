...
export class Game {
     ...
     * @returns boolean
     */
    static isGameDuration(threshold) {
    ...
    static async getWorld() {
        this.pauseWorld();
        await CustomFetchApi.get('/worldloader').then((response) => {
            this.loadWorld(response);
        });
    }
    static async setWorld(parameters = {}) {
        this.pauseWorld();
        let data = {
        ...
        await CustomFetchApi.post('/worldloader/change', data).then(async (response) => {
    ...
    static async loadWorld(response, parameters = {}) {
    ...
    static setup() {
        ...
        viewport.setup({
            background: document.getElementById("game_canvas"),
            player: document.getElementById("game_canvas2"),
            frontObjects: document.getElementById("game_canvas4"),
            sprite: document.getElementById("game_canvas3"),
            text: document.getElementById("text_canvas"),
            hud: document.getElementById("hud_canvas"),
        });
    ...
    static update(timestamp, first = false) {
