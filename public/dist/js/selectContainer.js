...
const skillContainer = {
    ...
    getSelectedType() {
        if (this.site === 'crops') {
            let crop_type = document.getElementById("selected_crop_type");
    ...
    showSelect(event) {
        ...
        let timeInputField = document.getElementsByName("time")[0];
        ...
        const levelInputField = document.getElementsByName("level")[0];
        // Check wether or not the player are in crops or mine
        if (Game.properties.building === "crops") {
            let seedInputField = document.getElementsByName("seeds")[0];
            ...
            let permitsInputField = document.getElementsByName("permits")[0];
        ...
        let experienceInputField = document.getElementsByName("experience")[0];
        let locationInputField = document.getElementsByName("location")[0];
