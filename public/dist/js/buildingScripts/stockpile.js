...
function show_menu(event) {
    ...
    let elementPos;
    let inputElement = document.getElementById("stck_menu_custom_amount");
    if (element.className == "inventory_item") {
...
const stockpileModule = {
    ...
    stockpileAction(amountSet = false, event) {
        ...
        let stckMenuInput = document.getElementById("stck_menu_custom_amount");
        if (amountSet) {
