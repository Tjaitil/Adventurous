...
export class ClientOverlayInterface {
    static shadowContainer = document.getElementById("news");
    static outerContainer = document.getElementById("news_content");
    static wrapper = document.getElementById("news_content_main_content");
    static sidePanel = document.getElementById("news_content_side_panel");
    static activeButton = null;
    static interfaceExitButton = null;
    static interfacePageTitle = "";
    static setup() {
    ...
    static show(content, sidebar = true) {
    ...
    static showContent(event = undefined, selectedButton = undefined) {
