<?php
    class getCropData extends dbh {
        ...
        public $user;
        function fetchData () {
            $sql = "SELECT farmlevel, experience, fields, workforce, avail_workforce, crop_type, crop_quant,
            crop_countdown, crop_type2, crop_quant2, crop_countdown2, crop_workforce, butch_workforce FROM Farmer WHERE Username='tjaitil'";
