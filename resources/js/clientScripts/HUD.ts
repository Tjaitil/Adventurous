...
export const HUD = {
    ...
    setup(width: number, height: number, top: number, left: number) {
        ...
        this.elements.huntedLocator =
            document.getElementById('HUD_hunted_locater');
    ...
    makeTutorialHUD() {
        ...
        tutorial_progressContainer.setAttribute(
            'id',
            'tutorial_progressContainer',
        );
        ...
        document
            ...
            .appendChild(tutorial_progressContainer);
