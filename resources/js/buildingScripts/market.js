...
if (document.getElementById('news_content').children[2] != null) {
    ...
    document
        .getElementById('select_item')
        .addEventListener('change', selectOpt);
                ...
                case 1:
                    document
                        ...
                        .getElementsByTagName(
                            'TABLE',
                        )[0].children[2].innerHTML = data[0];
                    document
                        .getElementById('my_offers')
                        .getElementsByTagName(
                            'TABLE',
                        )[0].children[2].innerHTML = data[1];
                    break;
                case 2:
                    console.log(
                        document
                            .getElementById('offers')
                            .querySelectorAll('#item_tooltip'),
                    );
                    if (
                        document
                            .getElementById('offers')
