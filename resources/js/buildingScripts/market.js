...
if (document.getElementById('news_content').children[2] != null) {
  ...
  document
    .getElementById('offer_types')
    .querySelectorAll('button')[0]
    .addEventListener('click', toggleOfferType);
  document
    .getElementById('offer_types')
...
function tradeEvent() {
  ...
  let buttons = document
    ...
    .children[0].children[2].querySelectorAll('button');
...
function toggleOfferType() {
  ...
  if (type === 'Sell' || type.length == 0) {
    ...
    document
      .getElementById('offer_types')
      .querySelectorAll('button')[0].style.backgroundColor = '';
    document
      .getElementById('offer_types')
      .querySelectorAll('button')[1].style.backgroundColor = '#e4cdb4';
  } else {
    ...
    document
      .getElementById('offer_types')
      .querySelectorAll('button')[0].style.backgroundColor = '#e4cdb4';
    document
      .getElementById('offer_types')
      .querySelectorAll('button')[1].style.backgroundColor = '';
  }
    ...
    if (response[0] != false) {
      ...
      switch (part) {
        case 1:
          document
            .getElementById('offers')
            .getElementsByTagName('TABLE')[0].children[2].innerHTML = data[0];
          document
            .getElementById('my_offers')
            .getElementsByTagName('TABLE')[0].children[2].innerHTML = data[1];
          break;
        case 2:
          console.log(
            document.getElementById('offers').querySelectorAll('#item_tooltip'),
          );
          if (
            document.getElementById('offers').querySelectorAll('#item_tooltip')
              .length > 0
            ...
            document
              ...
              .appendChild(document.getElementById('item_tooltip'));
          ...
          document
            ...
            .getElementsByTagName('TABLE')[0].children[1].innerHTML = data[2];
          break;
        case 3:
          document
            .getElementById('my_offers')
...
function trade() {
  ...
  let data =
    'model=Market' + '&method=trade' + '&id=' + id + '&amount=' + amount;
  ajaxP(data, function (response) {
    console.log(response);
    if (response[0] !== false) {
