<div id="conversation-container"
    class="invisible absolute z-20 h-[170px] rounded-sm border-4 border-primary-700 bg-orange-50 p-1 shadow-lg transition-[scale] duration-500 ease-in after:pointer-events-none after:absolute after:left-[-1px] after:top-[-1px] after:h-[calc(100%+2px)] after:w-[calc(100%+2px)] after:rounded-sm after:border-4 after:border-solid after:border-gray-950 after:content-['']">
