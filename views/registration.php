    ...
    <body onload="standardterms();">
        <section>
            ...
            <form name="registration" id="regi" method="post" action="/registration" >
                ...
                <span class="error"><?php echo $this->error['password_confirmErr']; ?></span></br>
                <span id="field"><label for="country">Country of origin:</label>
                ...
                First name: <input id="" type="text"/></br>
                Last name: <input id="" type="text" /></br>
                City: <input id="" type="text" /></br>
                Phone: <input id="hello" type="text" value="+"/> <input id="number" type="text" /></br>
                </br>
                </br>
