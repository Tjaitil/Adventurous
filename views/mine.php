            ...
            <div id="action_div" class="div_content">
                <div id="actions">
                    <p id="mining"></p>
                    <p id="time"></p>
                    <button id="fetch_minerals_action">Fetch Minerals</button>
                ...
                <div id="action_body">
                    ...
                    <img class="mineral_type" src="<?php echo constant('ROUTE_IMG') . $key['mineral_type'] . ' ore.png';?>"
                    ...
                    <div id="data_container">
                        <div id="data">
                            ...
                            <form id="data_form">
                                ...
                                <input type="text" id="selected_mineral_type" name="mineral" readonly />
                                ...
                                <div class="me-auto">    
                                    <input id="workforce_amount" name="workforce" type="number" min="0" required />
