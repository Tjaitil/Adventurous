            ...
            <div id="smith">
                ...
                <div id="minerals" class="mb-2">
                    <img src="<?php echo constant('ROUTE_IMG') . 'iron ore.png'; ?>" class="minerals" title="iron">
                    <img src="<?php echo constant('ROUTE_IMG') . 'steel ore.png'; ?>" class="minerals" title="steel">
                    <img src="<?php echo constant('ROUTE_IMG') . 'gargonite ore.png'; ?>" class="minerals" title="gargonite">
                    <img src="<?php echo constant('ROUTE_IMG') . 'adron ore.png'; ?>" class="minerals" title="adron">
                    <img src="<?php echo constant('ROUTE_IMG') . 'yeqdon ore.png'; ?>" class="minerals" title="yedqon">
                    <img src="<?php echo constant('ROUTE_IMG') . 'frajrite ore.png'; ?>" class="minerals" title="frajrite">
                </div>
                <?php
                    ...
                    ?>
                            <tr>
                                ...
                                <td> <img src="<?php echo constant('ROUTE_IMG') . $mineral . ' bar.png'; ?>" /> +
                                    ...
                                    =
                                    5 <img src="<?php echo constant('ROUTE_IMG') . $key['item'] . '.png'; ?>" />
                                </td>
                                <td>
                        ...
                        <?php endif; ?>
                            <td> 
                                ...
                                <button class="smith-mineral-action">Smith</button>
                            </td>
                        </tr>
                <?php endforeach;
                }; ?>
