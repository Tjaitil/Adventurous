...
<div id="content">
    ...
    <p id="">
        <table>
            ...
            $list_info[] = array('cooked carrot', array('carrot'), 0, 0);
            $list_info[] = array('roasted corn', array('corn'), 0, 0);
            $list_info[] = array('roasted cabbage', array('cabbage'), 0, 0);
            ...
            $list_info[] = array('fruit salad', array('apple', 'oranges', 'watermelon'), 0, 0);
