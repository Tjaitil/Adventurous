...
use Database\Factories\WarriorsLevelsFactory;
use Illuminate\Database\Eloquent\Casts\Attribute;
use Illuminate\Database\Eloquent\Factories\HasFactory;
use Illuminate\Database\Eloquent\Model;

/**
 * To be renamed to SoldierLevels in the future when armycamp is refactored
 *
 * @property int $id
...
{
    /**
     * @use HasFactory<WarriorsLevelsFactory>
     */
    use HasFactory;
